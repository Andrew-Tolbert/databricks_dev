...
#Azure KeyVault
AUTH_HEADER = {"Authorization" : "Bearer " + dbutils.secrets.get(scope = "at_secret_bucket", key = "api")}
#Naughty way
#AUTH_HEADER = {"Authorization" : "Bearer " + "dapiaa000a000a0a0a0aa0a0a0a0aa"}

# COMMAND ----------

# DBTITLE 1,Database and Table Config
DATABASE_NAME = "aht_dbsql_logging"
