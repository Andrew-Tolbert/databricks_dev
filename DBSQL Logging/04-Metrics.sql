...
SELECT user_name
,round(total_time_ms/1000/60,2) AS total_time_m
,round(photon_total_time_ms/1000/60,2) AS photon_time_m
,round((total_time_ms-photon_total_time_ms)/1000/60,2) AS non_photon_time_m
,round(photon_total_time_ms/total_time_ms * 100,2) as photon_pct
,query_id
,query_text
FROM queries 
WHERE timestamp_millis(query_start_time_ms) > current_date() - 30 
...
ORDER BY photon_pct ASC, total_time_ms DESC
LIMIT 20
