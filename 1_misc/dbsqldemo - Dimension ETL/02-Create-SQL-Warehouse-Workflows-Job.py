...
task_create_config_table = {
    "task_key": "create_config_table",
    "run_if": "ALL_SUCCESS",
    "notebook_task": {
      "notebook_path": nb_dir + "01-Create/Config Table",
      "warehouse_id": warehouse_id
    }
}
...
task_stage_source_file_initial = {
    "task_key": "stage_source_file_initial",
    "depends_on": [
      {
        "task_key": "create_patient_tables"
      },
...
task_browse_result_initial_load = {
    "task_key": "browse_result_initial_load",
    "depends_on": [
      {
        "task_key": "patient_initial_load"
      }
...
task_stage_source_file_incr_1 = {
    "task_key": "stage_source_file_incr_1",
    "depends_on": [
      {
        "task_key": "browse_result_initial_load"
      }
...
task_stage_source_file_incr_2 = {
    "task_key": "stage_source_file_incr_2",
    "depends_on": [
      {
        "task_key": "browse_result_incr1"
      }
    ...
    "run_if": "ALL_SUCCESS",
    "notebook_task": {
      "notebook_path": nb_dir + "_util/stage source file - incremental load #2",
    }
}

task_patient_load_incr2 = {
    "task_key": "patient_load_incr2",
    "depends_on": [
      {
        "task_key": "stage_source_file_incr_2"
      }
...
task_browse_result_incr2 = {
    "task_key": "browse_result_incr2",
    "depends_on": [
      {
        "task_key": "patient_load_incr2"
      }
...
tasks = [task_create_code_table, task_create_config_table, task_create_patient_tables, task_stage_source_file_initial, task_patient_initial_load, task_browse_result_initial_load, task_stage_source_file_incr_1, task_patient_load_incr1, task_browse_result_incr1, task_stage_source_file_incr_2, task_patient_load_incr2, task_browse_result_incr2]
...
job = post(workspace_url+"/api/2.1/jobs/create", headers, json)
