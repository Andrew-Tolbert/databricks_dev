...
# MAGIC
# MAGIC <a dbdemos-workflow-id="dbt" href="/#job/451386309356825">Click here to access your Workflow job</a>, it was setup and has been started when you installed your demo
# MAGIC
...
# MAGIC
# MAGIC <a dbdemos-repo-id="dbt-databricks-c360" href="/#workspace/Repos/andrew.tolbert@databricks.com/dbdemos-dbt-databricks-c360/README.md">Click here to explore the dbt pipeline installed as a repository</a><br/>
