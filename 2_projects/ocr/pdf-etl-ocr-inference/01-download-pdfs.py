...
# MAGIC %sql
# MAGIC CREATE CATALOG IF NOT EXISTS ahtsa_dev;
# MAGIC CREATE DATABASE IF NOT EXISTS ahtsa_dev.raw;
# MAGIC CREATE VOLUME IF NOT EXISTS ahtsa_dev.raw.data;
...
# MAGIC %sh
# MAGIC kaggle datasets download -d yasirabdaali/arxivorg-ai-research-papers-dataset -p /Volumes/ahtsa_dev/raw/data/ && \
# MAGIC unzip /Volumes/ahtsa_dev/raw/data/arxivorg-ai-research-papers-dataset.zip -d /Volumes/ahtsa_dev/raw/data/
...
VOLUME = "/Volumes/ahtsa_dev/raw/data/"
